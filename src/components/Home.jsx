        ...
        {productData.map((data, index)=>(
          ...
          className="product w-full h-[240px] sm:h-[500px]">
            ...
            <div className="productDetails absolute top-[8%] sm:top-[2%] right-[2%] w-[40%] p-[20px] sm:p-[50px]">
              <h1 className=" productTitle text-[18px] sm:text-[60px] font-bold text-white sm:tracking-[-2px] leading-[1] capitalize">{slideData[index].title}</h1>
              <h2 className="productPrice text-white text-[14px] sm:text-[30px] mt-[4px] sm:mt-[10px]">{data.price}</h2>
